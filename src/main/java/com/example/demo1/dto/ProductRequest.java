...
public record ProductRequest(
        ...
        @Schema(description = "Product stock", example = "10", requiredMode = Schema.RequiredMode.REQUIRED) @NotNull(message = "Stock is required") @Min(value = 0, message = "Stock must not be negative") Integer stock) {
}
